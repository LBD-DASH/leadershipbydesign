...
import { ArrowLeft, Zap, Clock, Download, CheckCircle, FileText, Users, Headphones } from "lucide-react";
    ...
    <div className="min-h-screen scroll-smooth">
      ...
      <section className="relative py-10 sm:py-16 md:py-24 px-4 overflow-hidden bg-primary">
        ...
        <div className="container mx-auto max-w-3xl relative z-10">
          ...
          <Link
            to="/products"
            className="inline-flex items-center gap-1.5 text-white/70 hover:text-white transition-colors mb-6 group"
          >
          ...
          <h1 className="text-center mb-3">
            <span className="block text-2xl sm:text-4xl md:text-5xl font-serif text-white mb-1">
              3 Scripts. R147.
            </span>
            <span className="block text-xl sm:text-2xl md:text-3xl font-serif bg-gradient-to-r from-white via-primary-foreground to-white bg-clip-text text-transparent">
              Use Today. 🚀
            </span>
          </h1>
          ...
          <div className="text-center">
            <motion.div
              ...
              className="text-4xl sm:text-5xl font-bold text-primary-foreground mb-3"
            >
              R147
            </motion.div>
            <Button
      ...
      <section className="py-10 sm:py-16 px-4 bg-background">
        <div className="container mx-auto max-w-3xl">
          <h2 className="text-xl sm:text-2xl font-serif text-center mb-6 text-foreground">
            What's Inside
          </h2>
      ...
      <section className="py-10 sm:py-16 px-4 bg-primary">
        <div className="container mx-auto max-w-2xl text-center">
          ...
          <p className="text-white/70 text-sm mb-5">
            Your next conversation is too important to improvise.
          </p>
          <div className="text-3xl sm:text-4xl font-bold text-primary-foreground mb-3">
            R147
          </div>
          <Button
            onClick={() => setCheckoutOpen(true)}
