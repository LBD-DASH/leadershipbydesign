...
import { CalendarIcon, Phone, RotateCcw, Lock, Loader2, LogOut, ChevronLeft, FileText, X, ChevronRight, Users, RefreshCw, Flame, ClipboardCheck, CheckCircle } from "lucide-react";
          ...
          <div className="hidden lg:flex w-1/2 border-l border-border flex-col bg-muted/30">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 text-sm">
              ...
              <div className="bg-muted/50 border border-border rounded-lg p-3 text-center">
                <p className="text-xs text-muted-foreground">11 Years · 4,000+ Leaders · 30+ Programmes · 30+ Organisations</p>
              </div>
            </div>
          </div>
        )}
