          ...
          <motion.div variants={fadeUp} className="grid md:grid-cols-5 gap-10 items-center">
            ...
            <div className="md:col-span-3">
              ...
              <p className="text-sm leading-relaxed mb-4" style={{ color: `${navy}99` }}>
                ...
                50+ organisations, Kevin brings a rare combination of scientific rigour and practical wisdom. a rare combination of scientific rigour and practical wisdom.
              </p>
