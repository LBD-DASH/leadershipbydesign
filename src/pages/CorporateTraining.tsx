            ...
            <div className="grid md:grid-cols-5 gap-8 items-center">
              ...
              <div className="md:col-span-3 text-center md:text-left">
                ...
                <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                  Business school faculty member, Master Practitioner in NLP & Time Line Therapy, and architect of the SHIFT Methodology™ and L1–L5 Leadership System. 30+ workshops. 4,000+ leaders developed across 30+ organisations including Discovery, FNB, and MIT Management School.
                </p>
                <Link to="/about">
