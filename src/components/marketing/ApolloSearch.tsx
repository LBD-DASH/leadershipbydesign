...
import { Search, Loader2, UserPlus, Globe, Building, CheckCircle2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              placeholder="Head of HR, CHRO, L&D Manager"
              className="mt-1"
            />
          </div>
          <div>
            ...
            <Input
              ...
              placeholder="South Africa, Namibia"
              className="mt-1"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <Input
              ...
              placeholder="insurance, financial services"
              className="mt-1"
            />
          </div>
        </div>
                  ...
                  {results.map(r => (
                    <TableRow key={r.id} className={imported.has(r.id) ? 'opacity-50' : ''}>
                      ...
                      <TableCell className="font-medium text-sm whitespace-nowrap">
                        ...
                        {r.linkedin_url && (
                          <a href={r.linkedin_url} target="_blank" rel="noopener noreferrer" className="ml-1 text-primary hover:underline text-xs">
                            LI
                          </a>
                        )}
                      </TableCell>
