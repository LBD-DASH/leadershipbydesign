...
import { ArrowLeft, ArrowRight, Sparkles, Copy, Download, Save, Check, Loader2 } from 'lucide-react';
...
export default function NeedsAnalysisWizard({ compact = false }: NeedsAnalysisWizardProps) {
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 2 && (
          <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            <Card>
              <CardHeader><CardTitle>Pain Points Checklist</CardTitle></CardHeader>
